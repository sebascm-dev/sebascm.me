...
export default function SetsChart({ matchpadel = [] }: { matchpadel: MatchPadel[] }) {
  ...
  return (
    <div className="relative max-h-[350px] border border-[#2E2D2D] rounded-md p-4 bg-[#1C1C1C]/50 shadow-lg backdrop-blur-[2px] h-fit hover:border-[#EDEDED]/30 transition-colors duration-300 mt-4 md:mt-4 lg:mt-8">

      <article>
        <p className="mb-6 text-sm text-gray-100/50 border-l-2 border-white/70 px-1.5 h-5">Últimos 12 meses en Sets</p>
